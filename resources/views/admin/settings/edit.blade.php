...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="text">{{ trans('cruds.setting.fields.text') }}</label>
                <input class="form-control {{ $errors->has('text') ? 'is-invalid' : '' }}" type="text" name="text" id="text" value="{{ old('text', $setting->text) }}">
                @if($errors->has('text'))
                    <div class="invalid-feedback">
                        {{ $errors->first('text') }}
                    </div>
            ...
            <div class="form-group">
                <label for="short_description">{{ trans('cruds.setting.fields.short_description') }}</label>
                <textarea class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" name="short_description" id="short_description">{{ old('short_description', $setting->short_description) }}</textarea>
            ...
            <div class="form-group">
                <label for="long_description">{{ trans('cruds.setting.fields.long_description') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('long_description') ? 'is-invalid' : '' }}" name="long_description" id="long_description">{!! old('long_description', $setting->long_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $setting->date) }}">
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $setting->number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('multi_image') ? 'is-invalid' : '' }}" id="multi_image-dropzone">
                </div>
