            ...
            <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('key') ? 'is-invalid' : '' }}" type="text" name="key"
                           id="key" value="{{ old('key', $setting->key) }}" required>
                    @if($errors->has('key'))
                ...
                @foreach(siteLanguages() as $locale)
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has($locale.'.text') ? 'is-invalid' : '' }}" type="text"
                               name="{{$locale}}[text]" id="{{$locale}}-text"
                               value="{{ old($locale.'.text', $setting->translate($locale, true)->text) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            id="{{$locale}}-short_description">{{ old($locale.'.short_description', $setting->translate($locale, true)->short_description) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            id="{{$locale}}-long_description">{!! old($locale.'.long_description', $setting->translate($locale, true)->long_description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text"
                           name="date" id="date" value="{{ old('date', $setting->date) }}">
                    @if($errors->has('date'))
                        <div class="invalid-feedback">
                            {{ $errors->first('date') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number"
                           name="number" id="number" value="{{ old('number', $setting->number) }}" step="1">
