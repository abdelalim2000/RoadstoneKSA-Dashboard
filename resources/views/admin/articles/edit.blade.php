    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.articles.update", [$article->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('seo_keywords') ? 'is-invalid' : '' }}" name="seo_keywords" id="seo_keywords">{{ old('seo_keywords', $article->seo_keywords) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('seo_description') ? 'is-invalid' : '' }}" name="seo_description" id="seo_description">{{ old('seo_description', $article->seo_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $article->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('article') ? 'is-invalid' : '' }}" name="article" id="article">{!! old('article', $article->article) !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('publish') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="publish" id="publish" value="1" {{ $article->publish || old('publish', 0) === 1 ? 'checked' : '' }}>
