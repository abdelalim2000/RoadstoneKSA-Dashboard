                ...
                @foreach(siteLanguages() as $locale)
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has($locale.'.title') ? 'is-invalid' : '' }}" type="text"
                               name="{{$locale}}[title]" id="{{$locale}}-title" value="{{ old($locale.'.title', '') }}"
                               required>
...
{{--                    </div>--}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            id="{{$locale}}-description">{!! old($locale.'.description') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('dry_performance') ? 'is-invalid' : '' }}" type="number"
                           name="dry_performance" id="dry_performance" value="{{ old('dry_performance', '') }}"
                           step="0.1" max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wet_performance') ? 'is-invalid' : '' }}" type="number"
                           name="wet_performance" id="wet_performance" value="{{ old('wet_performance', '') }}"
                           step="0.1" max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('rolling_resistance') ? 'is-invalid' : '' }}"
                           ...
                           value="{{ old('rolling_resistance', '') }}" step="0.1" max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('comfort_noise') ? 'is-invalid' : '' }}" type="number"
                           name="comfort_noise" id="comfort_noise" value="{{ old('comfort_noise', '') }}" step="0.1"
                           max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wear') ? 'is-invalid' : '' }}" type="number" name="wear"
                           id="wear" value="{{ old('wear', '') }}" step="0.1" max="5">
                    @if($errors->has('wear'))
                        <div class="invalid-feedback">
                            {{ $errors->first('wear') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('snow') ? 'is-invalid' : '' }}" type="number" name="snow"
                           id="snow" value="{{ old('snow', '') }}" step="0.1" max="5">
                    @if($errors->has('snow'))
                        <div class="invalid-feedback">
                            {{ $errors->first('snow') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('fuel_consumption') ? 'is-invalid' : '' }}" type="number"
                           name="fuel_consumption" id="fuel_consumption" value="{{ old('fuel_consumption', '') }}"
                           step="0.1" max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('durability') ? 'is-invalid' : '' }}" type="number"
                           name="durability" id="durability" value="{{ old('durability', '') }}" step="0.1" max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wet_handling') ? 'is-invalid' : '' }}" type="number"
                           name="wet_handling" id="wet_handling" value="{{ old('wet_handling', '') }}" step="0.1"
                           max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wet_grip') ? 'is-invalid' : '' }}" type="number"
                           name="wet_grip" id="wet_grip" value="{{ old('wet_grip', '') }}" step="0.1" max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('aquaplaning') ? 'is-invalid' : '' }}" type="number"
                           name="aquaplaning" id="aquaplaning" value="{{ old('aquaplaning', '') }}" step="0.1" max="5">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ice') ? 'is-invalid' : '' }}" type="number" name="ice"
                           id="ice" value="{{ old('ice', '') }}" step="0.1" max="5">
                    @if($errors->has('ice'))
                        <div class="invalid-feedback">
                            {{ $errors->first('ice') }}
                        </div>
                ...
                <div class="form-group">
                    <label for="locations">{{ trans('cruds.tire.fields.location') }}</label>
                    <div style="padding-bottom: 4px">
                        <span class="btn btn-info btn-xs select-all"
                              style="border-radius: 0">{{ trans('global.select_all') }}</span>
                        <span class="btn btn-info btn-xs deselect-all"
                    ...
                    <select class="form-control select2 {{ $errors->has('locations') ? 'is-invalid' : '' }}"
                            name="locations[]" id="locations" multiple>
                        @foreach($locations as $key=>$location)
                            <option
                                value="{{ $key }}" {{ in_array($key, old('locations', [])) ? 'selected' : '' }}>{{ $location }}</option>
                        @endforeach
                    </select>
