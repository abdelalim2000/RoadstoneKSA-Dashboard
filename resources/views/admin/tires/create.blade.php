...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tire.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tires.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cta_link') ? 'is-invalid' : '' }}" type="text" name="cta_link" id="cta_link" value="{{ old('cta_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cta_text') ? 'is-invalid' : '' }}" type="text" name="cta_text" id="cta_text" value="{{ old('cta_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dry_performance') ? 'is-invalid' : '' }}" type="number" name="dry_performance" id="dry_performance" value="{{ old('dry_performance', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wet_performance') ? 'is-invalid' : '' }}" type="number" name="wet_performance" id="wet_performance" value="{{ old('wet_performance', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rolling_resistance') ? 'is-invalid' : '' }}" type="number" name="rolling_resistance" id="rolling_resistance" value="{{ old('rolling_resistance', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comfort_noise') ? 'is-invalid' : '' }}" type="number" name="comfort_noise" id="comfort_noise" value="{{ old('comfort_noise', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wear') ? 'is-invalid' : '' }}" type="number" name="wear" id="wear" value="{{ old('wear', '') }}" step="0.1" max="5">
                @if($errors->has('wear'))
                    <div class="invalid-feedback">
                        {{ $errors->first('wear') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('snow') ? 'is-invalid' : '' }}" type="number" name="snow" id="snow" value="{{ old('snow', '') }}" step="0.1" max="5">
                @if($errors->has('snow'))
                    <div class="invalid-feedback">
                        {{ $errors->first('snow') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fuel_consumption') ? 'is-invalid' : '' }}" type="number" name="fuel_consumption" id="fuel_consumption" value="{{ old('fuel_consumption', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('durability') ? 'is-invalid' : '' }}" type="number" name="durability" id="durability" value="{{ old('durability', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wet_handling') ? 'is-invalid' : '' }}" type="number" name="wet_handling" id="wet_handling" value="{{ old('wet_handling', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wet_grip') ? 'is-invalid' : '' }}" type="number" name="wet_grip" id="wet_grip" value="{{ old('wet_grip', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aquaplaning') ? 'is-invalid' : '' }}" type="number" name="aquaplaning" id="aquaplaning" value="{{ old('aquaplaning', '') }}" step="0.1" max="5">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ice') ? 'is-invalid' : '' }}" type="number" name="ice" id="ice" value="{{ old('ice', '') }}" step="0.1" max="5">
                @if($errors->has('ice'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ice') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tire_features') ? 'is-invalid' : '' }}" name="tire_features[]" id="tire_features" multiple>
                    @foreach($tire_features as $id => $tire_feature)
                        <option value="{{ $id }}" {{ in_array($id, old('tire_features', [])) ? 'selected' : '' }}>{{ $tire_feature }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tire_designs') ? 'is-invalid' : '' }}" name="tire_designs[]" id="tire_designs" multiple>
                    @foreach($tire_designs as $id => $tire_design)
                        <option value="{{ $id }}" {{ in_array($id, old('tire_designs', [])) ? 'selected' : '' }}>{{ $tire_design }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('car_models') ? 'is-invalid' : '' }}" name="car_models[]" id="car_models" multiple>
                    @foreach($car_models as $id => $car_model)
                        <option value="{{ $id }}" {{ in_array($id, old('car_models', [])) ? 'selected' : '' }}>{{ $car_model }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('car_type') ? 'is-invalid' : '' }}" name="car_type_id" id="car_type_id">
                    @foreach($car_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('car_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
