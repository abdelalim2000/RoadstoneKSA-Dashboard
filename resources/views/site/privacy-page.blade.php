...
@section('title', 'Roadstone KSA - Privacy & Policy')
@section('og_title', 'Roadstone KSA - Privacy & Policy')
@section('seo_description',  trans('website.seo.privacy-seo-description') )
@section('og_description',  trans('website.seo.privacy-seo-description') )
@section('seo_keywords', trans('website.seo.privacy-seo-keywords') )
...
@section('content')
    ...
    <header class="about-header">
        ...
        <div class="header-img" style="background-image:url('{{ settingImage('privacy-page') }}');"></div>
    </header>
    <!-- end header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ trans('website.menu.privacy') }}</li>
                    </ol>
                </nav>
                <header>
                    <h1 class="about-heading">{{ settingText('privacy-page', 'text') }}</h1>
                </header>
                <div class="aricale-container">
                    <article class="aricale-about">
                        <p class="about-roadstone">
                            {{ settingText('privacy-page', 'shord_description') }}
                        </p>
                    </article>
                </div>
            </div>
